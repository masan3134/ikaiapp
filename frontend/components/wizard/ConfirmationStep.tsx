    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">
          Seçimlerinizi kontrol edin ve analizi başlatın
        </p>
      </div>
      ...
      <div className="bg-white border-2 border-gray-200 rounded-lg p-6">
        ...
        <div className="space-y-2">
          ...
          <div>
            ...
            <p className="font-medium text-gray-900">
              {selectedJobPosting?.department ||
                newJobPostingData.department ||
                "Bilgi yok"}
            </p>
          </div>
          <div>
            ...
            <p className="text-gray-700 text-sm line-clamp-3">
              {selectedJobPosting?.details ||
                newJobPostingData.details ||
                "Bilgi yok"}
            </p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="text-sm text-gray-700 space-y-1 list-disc list-inside">
              ...
              {uploadedFiles.length > 0 && (
                <li>{uploadedFiles.length} CV dosyası yüklenecek</li>
              )}
