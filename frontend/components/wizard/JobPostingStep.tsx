        ...
        if (lastJobId) {
          ...
          if (lastJob) {
            ...
            if (process.env.NODE_ENV === 'development') {
              console.log('✅ Auto-selected last used job posting:', lastJob.title);
            }
          }
        }
      }
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600 mt-1">Analiz için bir iş ilanı seçin veya yeni oluşturun</p>
      </div>
          ...
          {loading ? (
            ...
            <div className="text-center py-12 bg-gray-50 rounded-lg">
              ...
              <p className="text-gray-600">
                {searchTerm ? 'Arama sonucu bulunamadı' : 'Henüz iş ilanı bulunmuyor'}
              </p>
              <button
                onClick={() => searchTerm ? setSearchTerm('') : setActiveTab('new')}
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-gray-500 mt-2 line-clamp-2">{job.details}</p>
                    </div>
                    {selectedJobPosting?.id === job.id && !isNewJobPosting && (
                      <div className="ml-3">
        ...
        <div className="space-y-4">
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <div className="flex items-start gap-3">
              ...
              <div>
                <p className="text-sm text-blue-900 font-medium">Yeni İş İlanı</p>
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) => handleNewJobPostingChange('title', e.target.value)}
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) => handleNewJobPostingChange('department', e.target.value)}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => handleNewJobPostingChange('details', e.target.value)}
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) => handleNewJobPostingChange('notes', e.target.value)}
