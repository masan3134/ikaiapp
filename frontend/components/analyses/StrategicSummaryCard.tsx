...
import { Target, CheckCircle2, AlertTriangle, MessageSquare, Clock, Award } from 'lucide-react';
 ...
 */
export default function StrategicSummaryCard({ summary }: StrategicSummaryProps) {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md border-2 border-indigo-200 overflow-hidden">
      ...
      <div className={`p-5 ${getRecommendationStyle(summary.finalRecommendation)}`}>
      ...
      <div className="p-5 space-y-6">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-gray-900 text-sm">Yönetici Özeti</h4>
          </div>
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-gray-900 text-sm">核心 Güçlü Yönler</h4>
          </div>
        ...
        {summary.keyRisks && summary.keyRisks.length > 0 && (
          <div>
            <div className="flex items-center gap-2 mb-3">
              ...
              <h4 className="font-semibold text-gray-900 text-sm">Riskler ve Azaltma Stratejileri</h4>
            </div>
            <div className="space-y-3">
        ...
        <div>
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="font-semibold text-gray-900 text-sm">Önerilen Görüşme Soruları</h4>
          </div>
