...
export default function AnalysisStatusBadge({ status, hasError, hasResults }: AnalysisStatusBadgeProps) {
  ...
  const statusConfig = {
    COMPLETED: {
      ...
      icon: isPartialSuccess ? <AlertCircle className="w-3 h-3" /> : <CheckCircle className="w-3 h-3" />,
