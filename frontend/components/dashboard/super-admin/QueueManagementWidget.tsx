...
export default function QueueManagementWidget({ data }: QueueManagementWidgetProps) {
            ...
            <div key={queue.name} className="p-3 border border-slate-200 rounded-lg">
              ...
              <div className="grid grid-cols-4 gap-2 text-xs">
                <div className="text-center">
                  ...
                  <p className="font-bold text-blue-600">{queue.waiting || 0}</p>
                </div>
                <div className="text-center">
                  <p className="text-slate-600">Active</p>
                  <p className="font-bold text-green-600">{queue.active || 0}</p>
                </div>
                <div className="text-center">
                  <p className="text-slate-600">Completed</p>
                  <p className="font-bold text-slate-600">{queue.completed || 0}</p>
                </div>
                <div className="text-center">
