...
import { BarChart3, Wand2, FileText, Briefcase, Mail, ArrowUp, ArrowDown } from 'lucide-react';
...
export default function PlatformAnalyticsWidget({ data }: PlatformAnalyticsWidgetProps) {
  const stats = [
    {
      label: 'Toplam Analiz',
