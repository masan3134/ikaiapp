...
export default function SuperAdminHeader({
  ...
  return (
    <div className="bg-gradient-to-r from-rose-600 to-red-800 rounded-xl p-4 mb-4 text-white relative overflow-hidden">
      ...
      <div className="relative flex justify-between items-start">
        <div>
          ...
          <div className="flex gap-2 mt-3 flex-wrap">
            <div className="bg-red-700/40 backdrop-blur px-3 py-1.5 rounded-lg border border-white/20">
            ...
            <div className="bg-red-700/40 backdrop-blur px-3 py-1.5 rounded-lg border border-white/20">
              ...
              <p className="text-xl font-bold">{platformStats.uptime}%</p>
            </div>
            <div className="bg-red-700/40 backdrop-blur px-3 py-1.5 rounded-lg border border-white/20">
        ...
        <div className="flex items-center gap-2">
          <button className="p-2 bg-white/20 hover:bg-white/30 rounded-lg backdrop-blur transition-colors border border-white/30">
            <Bell className="w-5 h-5" />
          </button>
          <Link
            href="/super-admin"
            className="p-2 bg-white/20 hover:bg-white/30 rounded-lg backdrop-blur transition-colors border border-white/30"
          >
