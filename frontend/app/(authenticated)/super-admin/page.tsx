...
import { Building2, Users, TrendingUp, Calendar, Search, Filter, ToggleLeft, ToggleRight } from 'lucide-react';
...
export default function SuperAdminPage() {
  ...
  const [planFilter, setPlanFilter] = useState<'FREE' | 'PRO' | 'ENTERPRISE' | ''>('');
  ...
  const handleToggle = async (id: string) => {
    try {
      ...
      const isActiveFilter = statusFilter === 'active' ? true : statusFilter === 'inactive' ? false : undefined;
      const result = await getOrganizations(page, 10, searchQuery, planFilter || undefined, isActiveFilter);
      setOrganizations(result.data);
    } catch (error) {
      toast.error(parseApiError(error));
    }
  ...
  // Handle plan change
  const handlePlanChange = async (id: string, plan: 'FREE' | 'PRO' | 'ENTERPRISE') => {
    try {
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-1">Sistem geneli organizasyon yönetimi</p>
        </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-gray-900 mt-1">{stats.totalOrganizations}</p>
                </div>
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-3xl font-bold text-orange-600 mt-1">{stats.monthlyAnalyses}</p>
                </div>
          ...
          <div className="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-gray-50 rounded-lg">
                <p className="text-2xl font-bold text-gray-900">{stats.planBreakdown.FREE}</p>
                <p className="text-sm text-gray-600 mt-1">FREE</p>
              </div>
              <div className="text-center p-4 bg-blue-50 rounded-lg">
                <p className="text-2xl font-bold text-blue-600">{stats.planBreakdown.PRO}</p>
                <p className="text-sm text-gray-600 mt-1">PRO</p>
              </div>
              <div className="text-center p-4 bg-purple-50 rounded-lg">
                <p className="text-2xl font-bold text-purple-600">{stats.planBreakdown.ENTERPRISE}</p>
