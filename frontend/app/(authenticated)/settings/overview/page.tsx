...
import {
  BarChart3, Users, Briefcase, Calendar, FileText,
  TrendingUp, Clock, ArrowRight, Sparkles, Crown,
  CheckCircle2, AlertCircle, User, Building2, Bell, Shield
} from 'lucide-react';
...
export default function SettingsOverviewPage() {
  ...
  const quickActions = [
    ...
    { name: 'İş İlanları', href: '/job-postings', icon: Briefcase, color: 'green' },
    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all group">
          ...
          <p className="text-3xl font-bold text-gray-900">{stats?.totalCandidates || 0}</p>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 hover:shadow-md transition-all group">
          ...
          <h3 className="text-sm font-medium text-gray-600 mb-1">İş İlanları</h3>
          <p className="text-3xl font-bold text-gray-900">{stats?.totalJobPostings || 0}</p>
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium text-gray-900">
                    {user?.createdAt ? new Date(user.createdAt).toLocaleDateString('tr-TR', { year: 'numeric', month: 'short' }) : '-'}
                  </span>
                </div>
              </div>
              ...
              {usage?.warnings && usage.warnings.length > 0 && (
                <div className="pt-3 border-t border-gray-200">
                  {usage.warnings.map((warning, idx) => (
                    <div key={idx} className="flex items-start gap-2 p-2 bg-yellow-50 rounded text-xs">
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{ width: `${Math.min(usage?.percentages?.analysis || 0, 100)}%` }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{ width: `${Math.min(usage?.percentages?.cv || 0, 100)}%` }}
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3">
                <div
                  ...
                  style={{ width: `${Math.min(usage?.percentages?.user || 0, 100)}%` }}
                />
              </div>
            </div>
          </div>
      ...
      <Card title="Ayarlar Bölümleri">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          >
            <User className="text-blue-600 mb-3 group-hover:scale-110 transition-transform" size={24} />
            <h3 className="font-medium text-gray-900 mb-1">Profil</h3>
            <p className="text-sm text-gray-600">Kişisel bilgilerinizi düzenleyin</p>
          </Link>
          ...
          >
            <Building2 className="text-purple-600 mb-3 group-hover:scale-110 transition-transform" size={24} />
          ...
          >
            ...
            <h3 className="font-medium text-gray-900 mb-1">Kullanım & Planlar</h3>
          ...
          >
            <Bell className="text-orange-600 mb-3 group-hover:scale-110 transition-transform" size={24} />
          ...
          >
            <Shield className="text-red-600 mb-3 group-hover:scale-110 transition-transform" size={24} />
