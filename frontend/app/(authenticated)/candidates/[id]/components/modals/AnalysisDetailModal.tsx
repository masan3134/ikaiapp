            ...
            <>
              ...
              <div className="grid md:grid-cols-3 gap-4">
                {result.experienceScore !== null &&
                  result.experienceScore !== undefined && (
                ...
                {result.educationScore !== null &&
                  result.educationScore !== undefined && (
                ...
                {result.softSkillsScore !== null &&
                  result.softSkillsScore !== undefined && (
                ...
                {result.extraScore !== null &&
                  result.extraScore !== undefined && (
              ...
              {result.positiveComments &&
                result.positiveComments.length > 0 && (
                  <div>
              ...
              {result.negativeComments &&
                result.negativeComments.length > 0 && (
                  <div>
                    <h3 className="text-lg font-bold text-gray-900 mb-3 flex items-center gap-2">
