...
export const metadata: Metadata = {
  ...
  description:
    "İKAI HR fiyatlandırma planları. İhtiyacınıza uygun planı seçin ve işe alım süreçlerinizi dönüştürün.",
};
      ...
      <section className="py-16 bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg md:text-xl text-indigo-100 max-w-2xl mx-auto">
            İhtiyacınıza uygun planı seçin. Her zaman değiştirebilir veya iptal
            edebilirsiniz.
          </p>
        </div>
      </section>
              ...
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    ...
                    <th className="px-6 py-3 text-center text-sm font-semibold text-indigo-600 bg-indigo-50">
                      PRO
                    </th>
                    <th className="px-6 py-3 text-center text-sm font-semibold text-gray-900">
                      ENTERPRISE
                ...
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 text-sm text-center font-semibold text-indigo-600 bg-indigo-50">
                      Sınırsız
                    </td>
                    <td className="px-6 py-4 text-sm text-center text-gray-600">
                      Özel
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 text-sm">
                  Free plan ile ayda 10 analiz ve 50 CV yükleyebilirsiniz. 2
                  kullanıcı ekleyebilir ve temel özellikleri kullanabilirsiniz.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  düşürebilirsiniz. Değişiklikler anında geçerli olur.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                <h3 className="text-lg font-semibold text-gray-900 mb-2">
                ...
                <p className="text-gray-600 text-sm">
                  ...
                  Enterprise planlar için özel faturalandırma seçenekleri
                  mevcuttur.
                </p>
              </div>
              <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <p className="text-gray-600 text-sm">
                  Tüm verileriniz şifrelenmiş olarak saklanır. Multi-tenant
                  mimarisi ile her organizasyon tamamen izole ortamda çalışır.
                </p>
              </div>
            </div>
          </div>
